...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse> deleteCategory(@PathVariable("productId") Integer productId) throws ProductNotExistException {
    ...
    public ResponseEntity<List<ProductDto>> searchProduct(@PathVariable("productName") String productName) throws ProductNotExistException {


        List<ProductDto> all = productService.searchProduct(productName);
